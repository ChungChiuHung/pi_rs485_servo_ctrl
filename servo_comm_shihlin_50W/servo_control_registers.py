...
class ServoControlRegistry(Enum):
    ...
    POS_PULSES_CMD_L = Register(0x0905, "Command pulses", 1)
    POS_PULSES_CMD_H = Register(0x0906, "Command pulses", 1)
    POS_EXE_MODE = Register(0x0907, "Positioning test operation", 1)
    CTRL_MODE_SEL = Register(0x0901, "To quit this mode by 0x0000 written at address", 1)
